...
##perform gitian builds
 ...
 Build dollylited and litecoin-qt on Linux32, Linux64, and Win32:
...
**Perform Mac build:**
  ...
  Dollylite 0.8.x is built with MacPorts.  0.9.x will be Homebrew only.
	...
	python2.7 contrib/macdeploy/macdeployqtplus Dollylite-Qt.app -add-qt-tr $T -dmg -fancy contrib/macdeploy/fancy.plist

 Build output expected: Dollylite-Qt.dmg
